<?php
namespace Codazon\ThemeOptions\Model\ResourceModel\Config\Data\Collection;

/**
 * Interceptor class for @see \Codazon\ThemeOptions\Model\ResourceModel\Config\Data\Collection
 */
class Interceptor extends \Codazon\ThemeOptions\Model\ResourceModel\Config\Data\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addScopeFilter($scope, $scopeId, $themeId, $section)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addScopeFilter', func_get_args(), $pluginInfo) : parent::addScopeFilter($scope, $scopeId, $themeId, $section);
    }
